...
#Subscribers and Publishers
		...
		self._Ultrasonic_Value = rospy.Publisher('left_arduino_value',Float32,queue_size = 10)
...
#######################################################################################################################
#Speed subscriber
		self._left_motor_speed = rospy.Subscriber('left_wheel_cmd',Float32,self._Update_Left_Speed)

		self._right_motor_speed = rospy.Subscriber('right_wheel_cmd',Float32,self._Update_Right_Speed)
